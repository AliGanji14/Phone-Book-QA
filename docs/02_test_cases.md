...
**مستند:** تست‌کیس‌ها (تحویلی شماره ۱) و تقسیم‌بندی تست‌ها (تحویلی شماره ۳)
**نحوه اجرای تست‌های اتومات:** `venv\Scripts\python.exe -m pytest tests -v`
...
| نوع | تعداد | توضیح |
|---|---|---|
| Automated (pytest + ZMQ) | ۳۳ | قابلیت اجرای مجدد در هر بیلد — `pytest tests` |
| Manual | ۴ | TC-C-05، TC-C-06، TC-M-01، TC-M-02 — نیاز به بررسی دیتابیس، ری‌استارت سرور و کلاینت همزمان دارند |
